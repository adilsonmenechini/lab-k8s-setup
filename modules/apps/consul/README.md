...
|------|-------------|------|---------|:--------:|
| <a name="input_chart_namespace"></a> [chart\_namespace](#input\_chart\_namespace) | namesapce of the helm chart | `string` | `"vault"` | no |
| <a name="input_chart_version"></a> [chart\_version](#input\_chart\_version) | version of the helm chart | `string` | `"1.4.0"` | no |
